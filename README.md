<p align="center">
  ...
  <h1 align="center">Github Readme Linus Quotes</h1>
  <h3 align="center">Random Linus Torvalds quotes for your GitHub README.</h3>
</p>
...
A fork of [PiyushSuthar/github-readme-quotes](https://github.com/PiyushSuthar/github-readme-quotes) with all quotes replaced by **Linus Torvalds** quotes only.
...
| quote           | -        | Custom quote (URL encoded)                       |
| author          | -        | Custom author name                               |
| quoteColor      | -        | Quote text color (hex without `#`)               |
| authorColor     | -        | Author text color (hex without `#`)              |
| backgroundColor | -        | Background color (hex without `#`)               |
| symbolColor     | -        | Quote symbol color (hex without `#`)             |
...
- Forked from [PiyushSuthar/github-readme-quotes](https://github.com/PiyushSuthar/github-readme-quotes)
- Original quotes API: [skolakoda/programming-quotes-api](https://github.com/skolakoda/programming-quotes-api)
